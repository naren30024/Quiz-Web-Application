...
export default function SignUp(props) {
  ...
  const handleSubmit = (event) => {
    ...
    if (data.get('firstName') === "" || data.get('lastName') === "" || data.get('email') === "" || data.get('password') === ""){
      ...
      const senddata2={
        firstName:senddata1["firstName"],
        lastName:senddata1["lastName"],
        email:senddata1["email"],
        password:senddata1["password"]
      }
      console.log(senddata2)
      axios.post('http://localhost/php-react/register-login-php/insert.php',senddata1)
      .then((result)=> {
